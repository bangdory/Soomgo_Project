    ...
    <div class="reply-form">
        ...
        <form id="reply-form" class="reply-form-newContent">
            ...
            <div class="custom-file-input">
                <input type="file" name="cr_file" accept="image/gif, image/jpeg, image/png, image/bmp"
            ...
            <div class="reply-item" id="reply-${reply.cr_no}">
                ...
                <div class="community-reply-content-text">
                    ...
                    <div class="community-reply-content">
                            <div class="community-reply-originContent">
                                    ${reply.cr_content}
                            </div>
                        <textarea class="community-reply-modifyContent" style="display: none">${reply.cr_content}</textarea>
                    </div>
                ...
                <div class="modifiyCancel" style="display: none">
                    <button type="button" class="save-modify">저장</button>
                    <button type="button" class="cancel-modify">취소</button>
                </div>
            </div>
        </c:forEach>
    </div>
        ...
        document.querySelectorAll('.update-btn').forEach(button => {
            button.addEventListener('click', function (event) {
                ...
                fetch('user/isLoggedIn')
                    ...
                    .then(data => {
                        if (data.loggedIn) {
                            const content = document.querySelector('.community-reply-originContent');
                            const modifyContent = document.querySelector('.community-reply-modifyContent');
                            const icon = document.querySelector('.icon');
                            const button = document.querySelector('.modifiyCancel');
                ...
                // 수정취소
                document.querySelectorAll('.cancel-modify').forEach(button => {
                    button.addEventListener('click', function (event) {
                        const replyItem = event.currentTarget.closest('.reply-item');
                ...
                <%--    .then(data => {--%>
                <%--        if (data.loggedIn) {--%>
                <%--            &lt;%&ndash;console.log(boardNo);&ndash;%&gt;--%>
